const PWASettings = {
    ...
    "dswRules": {
        "images": {
            "match": {"extension": ["jpg", "gif", "png", "jpeg"]},
            "apply": {
                "cache": {
                    "name": "cachedImages",
                    "version": "1"
...
// out of an existing one
        ...
        (function (global) {
            ...
            var DSW = {version: '1.12.2', build: '1538357317512', ready: null};
                            ...
                            DSW.ready = new Promise(function (resolve, reject) {
                                ...
                                if (navigator.serviceWorker) {
                                    if (!navigator.serviceWorker.controller) {
                                        ...
                                        Promise.all([documentBodyPromise, navigator.serviceWorker
